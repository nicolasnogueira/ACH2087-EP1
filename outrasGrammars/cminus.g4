...
statement_list : statement_list_lrec | empty ;
statement_list_lrec: statement_list | empty ;
statement : expression_stmt | compound_stmt | selection_stmt | iteration_stmt | return_stmt ;
expression_stmt : expression ';' | ';' ;
selection_stmt : if ( expression ) statement | if ( expression ) statement else statement ;
iteration_stmt : while ( expression ) statement ;
return_stmt : return ';' | return expression ';' ;
expression : var = expression_lrec | simple_expression ;
expression_lrec: var = expression | simple_expression ;
